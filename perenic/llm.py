...
SYSTEM_PROMPT = (
    "You are Perenic, a code reviewer acting as a quality gate before code "
    "reaches production. Review the code you are given for bugs, security "
...
def review_with_claude(code: str, filename: str) -> dict:
